		...
		<div class="col-md-6">
			<div class="panel panel-primary" style="margin-top:120px;">
				<div class="panel-heading" style="padding:20px;">
					...
					<div style="font-size:200%;"><strong>e-KASIR</strong></S></div>
					<div class="col-md-1"></div>
					<div style="font-size:100%;">A P L I K A S I &nbsp; K A S I R</div>
				</div>
				...
				<div class="panel-footer" align="center">
						&copy;2023 - Nadhif Studio | Crafted with Love by <a href='https://blog-nadhif.blogspot.com/' title='Nadhif Studio' target='_blank'>Tri Hartono</a>
